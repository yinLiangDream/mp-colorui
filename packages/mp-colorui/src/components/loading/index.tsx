...
export default function ClLoading(props: IProps) {
  ...
  const renderLoading = () => {
    const renderContent = () => {
      if (props.type === "bar") return barComponent;
      if (props.type === "line") return lineComponent;
      if (props.type === "modal") return modalComponent;
      if (props.type === "image") return imageComponent;
